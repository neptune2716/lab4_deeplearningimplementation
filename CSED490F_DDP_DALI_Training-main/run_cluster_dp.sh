...
YOUR_NAME="${YOUR_NAME:-cyrilhup}"
YOUR_HOME_PATH="${YOUR_HOME_PATH:-/mnt/c/Users/cyril/OneDrive/Bureau/Postech/Deep_learning/lab4}"
REPO_DIR="${REPO_DIR:-CSED490F_DDP_DALI_Training-main}"
DATASET_DIR="${DATASET_DIR:-/mnt/c/Users/cyril/OneDrive/Bureau/Postech/Deep_learning/lab4/dataset}"
